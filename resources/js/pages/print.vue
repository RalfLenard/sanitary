...
<template>
  <div class="container">
    ...
    <div class="info">
      <p class="a">{{ inspection.name_of_establishment }}</p>
      ...
      <div class="signature">
        ...
        <img v-if="inspection.inspector_name.toLowerCase() === 'aaron jay c. gonzales'" class="sir-a" src="/images/A-sig.png" alt="Signature">
        <img v-else class="sir-g" src="/images/sir-g.png" alt="Signature">
        <img class="sir-doc" src="/images/DOC-B.png" alt="Signature">
      </div>
    </div>
  </div>
</template>
